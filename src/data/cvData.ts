export const cvData = {
  ...
  productOS: {
    layers: [
      {
        name: "Layer 1: The Foundation",
        description: "Data integrity and infrastructure reliability. Without clean data, AI is useless."
      },
      {
        name: "Layer 2: The Intelligence",
        description: "LLM orchestration and context-aware processing. Turning data into insights."
      },
      {
        name: "Layer 3: The Experience",
        description: "Intuitive interfaces that bridge the gap between complex AI and user needs."
      }
    ]
  }
};
